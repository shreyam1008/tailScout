...
The repository's shared status fixtures and the public demo use documentation-only
identities, `example.ts.net` names, and reserved example IP ranges. Keep real
LocalAPI output out of source, screenshots, release notes, and Store assets.
